...
const tagSeed = [
  {
    ...
    slug: "routine-visage",
    description: "Produits adaptes aux routines quotidiennes du visage.",
  },
  {
    title: "Promotions ete",
    slug: "promotions-ete",
    description: "Selection de produits en remise pendant la periode estivale.",
  },
  {
    title: "Soins anti-acne",
    slug: "soins-anti-acne",
    description: "Soins cibles pour peaux a imperfections.",
  },
  {
    title: "Nos coups de coeur",
    slug: "nos-coups-de-coeur",
    description: "Selections recommandees par l'equipe Zayna.",
  },
];
...
const productSeed: ProductSeed[] = [
  {
    ...
    tagSlugs: ["routine-visage", "nos-coups-de-coeur"],
  ...
  },
  {
    ...
    tagSlugs: ["promotions-ete", "nos-coups-de-coeur"],
  ...
  },
  {
    ...
    brandSlug: "svr",
    categorySlugs: ["visage", "promos"],
    tagSlugs: ["soins-anti-acne", "routine-visage"],
...
async function main() {
  ...
  for (const product of productSeed) {
    ...
    const productTagRows = (product.tagSlugs || [])
  ...
  const homepageSectionsSeed = [
    {
      ...
      order: 0,
      config: {
        autoplayMs: storefrontSettingsSeed.heroAutoplayMs,
      },
      limit: null,
      ctaLabel: null,
      ctaLink: null,
    },
    {
      ...
      title: storefrontSettingsSeed.featuredCategoriesTitle,
      subtitle: storefrontSettingsSeed.featuredCategoriesSubtitle,
      order: 1,
      config: {
        featuredOnly: true,
      },
      limit: storefrontSettingsSeed.featuredCategoriesLimit,
      ctaLabel: "Voir tout",
      ctaLink: "/shop",
    },
    {
      ...
      title: storefrontSettingsSeed.promotionsTitle,
      subtitle: storefrontSettingsSeed.promotionsSubtitle,
      order: 2,
      config: {
      ...
      limit: storefrontSettingsSeed.promotionsLimit,
    ...
    },
    {
      key: "best-sellers",
      type: "product_list" as const,
      title: storefrontSettingsSeed.bestSellersTitle,
      subtitle: storefrontSettingsSeed.bestSellersSubtitle,
      order: 3,
      config: {
      ...
      limit: storefrontSettingsSeed.bestSellersLimit,
      ctaLabel: null,
      ctaLink: null,
    },
    {
      key: "new-arrivals",
      type: "product_list" as const,
      title: storefrontSettingsSeed.newArrivalsTitle,
      subtitle: storefrontSettingsSeed.newArrivalsSubtitle,
      order: 4,
      config: {
        sourceType: "newest",
        layout: "grid",
      ...
      limit: storefrontSettingsSeed.newArrivalsLimit,
      ctaLabel: null,
      ctaLink: null,
    },
    {
      ...
      title: storefrontSettingsSeed.brandsTitle,
      subtitle: storefrontSettingsSeed.brandsSubtitle,
      order: 5,
      config: {},
      limit: storefrontSettingsSeed.brandsLimit,
      ctaLabel: null,
      ctaLink: null,
    },
    {
      ...
      title: storefrontSettingsSeed.trustTitle,
      subtitle: storefrontSettingsSeed.trustSubtitle,
      order: 6,
      config: {},
      limit: null,
      ctaLabel: null,
    ...
    },
    {
      ...
      title: storefrontSettingsSeed.loyaltyTitle,
      subtitle: storefrontSettingsSeed.loyaltyDescription,
      order: 7,
      config: {
        badge: storefrontSettingsSeed.loyaltyBadge,
        title: storefrontSettingsSeed.loyaltyTitle,
        description: storefrontSettingsSeed.loyaltyDescription,
        ctaLabel: storefrontSettingsSeed.loyaltyCtaLabel,
        ctaHref: storefrontSettingsSeed.loyaltyCtaHref,
        highlightText: storefrontSettingsSeed.loyaltyHighlightText,
        imageUrl: storefrontSettingsSeed.loyaltyImageUrl,
      },
      limit: null,
      ctaLabel: storefrontSettingsSeed.loyaltyCtaLabel,
      ctaLink: storefrontSettingsSeed.loyaltyCtaHref,
    },
    {
      key: "newsletter",
      type: "newsletter" as const,
      title: storefrontSettingsSeed.newsletterTitle,
      subtitle: storefrontSettingsSeed.newsletterDescription,
      order: 8,
      config: {
        placeholder: storefrontSettingsSeed.newsletterPlaceholder,
        buttonLabel: storefrontSettingsSeed.newsletterButtonLabel,
        successMessage: storefrontSettingsSeed.newsletterSuccessMessage,
        errorMessage: storefrontSettingsSeed.newsletterErrorMessage,
      },
      limit: null,
      ctaLabel: null,
      ctaLink: null,
  ...
  console.log(
    `Seeded ${categorySeed.length} categories, ${brandSeed.length} brands, ${tagSeed.length} tags, ${productSeed.length} products, ${promoSeed.length} promo codes, ${heroSlidesSeed.length} hero slides, ${trustItemsSeed.length} trust items, ${siteLinksSeed.length} site links, ${socialLinksSeed.length} social links and ${homepageSectionsSeed.length} homepage sections.`
  );
}
